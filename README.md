...
- Altere as regras iniciais do banco de dados em -> Realtime Database -> [Regras](https://console.firebase.google.com/project/whatsapp-59702/database/whatsapp-59702-default-rtdb/rules?hl=pt) pelas regras [aqui](./database.rules.json) sugeridas.
